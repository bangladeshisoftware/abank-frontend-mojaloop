    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <img src='/logo.png' width={185} height={70} />
        </Box>
        {isMobile && (
      ...
      >
        <Toolbar>
          ...
          <Typography   sx={{ flexGrow: 1, fontWeight: 500 }}
            className='text-gray-500 text-xl md:block hidden' variant='body2' color='text.secondary'>
            Welcome back! <span className='text-[#ff4900]'>{profile?.full_name}</span>
          </Typography>
          <Box>
            <Typography
              variant='caption'
